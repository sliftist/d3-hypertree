...
export const layerSrc = [
    ...
    */
    ...
    (v, ud: UnitDisk) => new NodeLayer(v, {
        ...
        fill: n => {
            if (ud.view.hypertree.args.geometry.layerOptions['nodes']?.nodeColor) {
                return ud.view.hypertree.args.geometry.layerOptions['nodes']?.nodeColor(n);
            } else {
                return undefined;
            }
        },
    ...
    (v, ud: UnitDisk) => new LabelLayer(v, {
        ...
        color: (n) => ud.view.hypertree.args.geometry.layerOptions['labels']?.labelColor(n) || undefined,
