...
exports.layerSrc = [
    ...
    */
    ...
    (v, ud) => new link_layer_1.ArcLayer(v, {
        ...
        classed: (s, w, c) => s
            .style("stroke", d => {
            if (ud.view.hypertree.args.geometry.layerOptions['link-arcs'].linkColor) {
                return (ud.view.hypertree.args.geometry.layerOptions['link-arcs'].linkColor(d));
            }
            return ((d.pathes && d.pathes.isPartOfAnyHoverPath) ? d.pathes && d.pathes.finalcolor : d.pathes && d.pathes.finalcolor) || c(d);
        })
    ...
    (v, ud) => new node_layer_1.NodeLayer(v, {
        ...
        fill: n => {
            var _a, _b;
            if ((_a = ud.view.hypertree.args.geometry.layerOptions['nodes']) === null || _a === void 0 ? void 0 : _a.nodeColor) {
                return (_b = ud.view.hypertree.args.geometry.layerOptions['nodes']) === null || _b === void 0 ? void 0 : _b.nodeColor(n);
            }
            else {
                return undefined;
            }
    ...
    (v, ud) => new label_layer_1.LabelLayer(v, {
        ...
        color: (n) => { var _a; return ((_a = ud.view.hypertree.args.geometry.layerOptions['labels']) === null || _a === void 0 ? void 0 : _a.labelColor(n)) || undefined; },
