...
export declare class Hypertree {
    ...
    constructor(view: {
        parent: HTMLElement;
    }, args: PartialRecursive<HypertreeArgs>);
    api: {
        setModel: (model: PartialRecursive<HypertreeArgs>) => Promise<void>;
    ...
    private sum;
    protected updateLang_(dl?: number): void;
    ...
    animateToλ(ok: any, err: any, newλ: any): void;
    animateTo(resolve: any, reject: any, newP: C, newλ: number): void;
