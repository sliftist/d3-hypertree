...
export declare const navBackgroundLayers: (((v: any, ud: UnitDisk) => BackgroundLayer) | ((v: any, ud: UnitDisk) => CellLayer) | ((v: any, ud: UnitDisk) => ArcLayer) | ((v: any, ud: UnitDisk) => LabelLayer) | ((v: any, ud: UnitDisk) => SymbolLayer))[];
