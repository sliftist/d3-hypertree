...
export declare class D3UpdatePattern {
    ...
    private mayEval;
    private updateData;
    addTextBackgroundRects(paddingLeftRight: any, paddingTopBottom: any, height: any, layername: any): void;
}
export declare var bboxOffset: (d: any, cacheId?: string, θn?: any) => {
    re: number;
    im: number;
};
