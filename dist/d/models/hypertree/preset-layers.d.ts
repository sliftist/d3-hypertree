...
export declare const layerSrc: (((v: any, ud: UnitDisk) => BackgroundLayer) | ((v: any, ud: UnitDisk) => CellLayer) | ((v: any, ud: UnitDisk) => FocusLayer) | ((v: any, ud: UnitDisk) => NodeLayer) | ((v: any, ud: UnitDisk) => ArcLayer) | ((v: any, ud: UnitDisk) => StemLayer) | ((v: any, ud: UnitDisk) => SymbolLayer) | ((v: any, ud: UnitDisk) => ImageLayer) | ((v: any, ud: UnitDisk) => LabelLayer) | ((v: any, ud: UnitDisk) => LabelForceLayer) | ((v: any, ud: UnitDisk) => InteractionLayer) | ((v: any, ud: UnitDisk) => InteractionLayer2) | ((v: any, ud: UnitDisk) => TraceLayer))[];
